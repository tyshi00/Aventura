...
The actual app lives in [`aventura/`](./aventura), see [`aventura/README.md`](./aventura/README.md) for the same rundown below. This repo also carries Light's SDK scaffolding it's built on, plus Light's own Tracker sample app in [`tool/`](./tool), kept around as a working reference.
...
Check the [Releases](../../releases) page for a ready-to-install APK, or build it yourself:
